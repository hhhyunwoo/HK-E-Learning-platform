...
<aside>
  <ul id="note_menu">
    <li><img src="/whitecow-home-folder/imgs/recv.png" alt="recv" title="recv" /><a href="note.php">받은쪽지함</a></li>
    <li><img src="/whitecow-home-folder/imgs/send.png" alt="recv" title="recv"  /><a href="note_send.php"><b>보낸쪽지함</b></a></li>
  </ul>
</aside>
<div id="main_in">
      ...
      <tbody>
        <tr>
          <td class="tc"><input type="checkbox" /></td> <!---체크박스 -->
            ...
            <td><a href='/whitecow-home-folder/page/note/send_read.php?idx=<?php echo $recv['idx']; ?>'><?php echo $note_title; ?></a></td> <!---제목 -->

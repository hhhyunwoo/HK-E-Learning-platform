...
<aside>
	<ul id="note_menu">
		<li><img src="/whitecow-home-folder/imgs/recv.png" alt="recv" title="recv" /><a href="note.php"><b>받은쪽지함</b></a></li>
		<li><img src="/whitecow-home-folder/imgs/send.png" alt="recv" title="recv" /><a href="note_send.php">보낸쪽지함</a></li>
	</ul>
</aside>
<div id="main_in">
      ...
      $note_title=$recv["title"]; 
        ...
        <tbody>
          <tr>
            ...
            <td><a href='/whitecow-home-folder/page/note/recv_read.php?idx=<?php echo $recv['idx']; ?>'><?php echo $note_title; ?></a></td> <!---제목 -->

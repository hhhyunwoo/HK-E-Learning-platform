...
<aside>
	<ul id="note_menu">
		<li><img src="/whitecow-home-folder/imgs/recv.png" alt="recv" title="recv" /><a href="/whitecow-home-folder/page/note.php">받은쪽지함</a></li>
		<li><img src="/whitecow-home-folder/imgs/send.png" alt="recv" title="recv" /><a href="/whitecow-home-folder/page/note_send.php">보낸쪽지함</a></li>
	</ul>
</aside>
<div id="note_read">
	<div id="note_read_bt">
